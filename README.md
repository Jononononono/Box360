...
- Arduino Nano
- 2 Tactile switches
- Aliexpress i2c displat (TENSTAR 12864-59N IIC 4P LCD Module I2C ST7567S COG Graphic Display Screen Board LCM Panel 128x64 Dot Matrix Screen)
- Aliexpress HDMI fpc cable (Micro HDMI, HDMI port, 10cm Cable)(HDMI-Compatible Connector Flex Flat Cable for Raspberry Pi 4 Micro Mini HDMI-Compatible 20pin FFC 10 20 50cmRibbon FPV Orange Pi )
- IR Sensor
- Some old TV Remote
...
### Steps
Will be released through the development of the project
